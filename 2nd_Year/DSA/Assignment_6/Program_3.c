...
void createLinkedList(){
	if(first->next==NULL){
		...
		printf("Linked List has already been created!\n");
	}
}
...
void insertElement(){
	if(first->next!=NULL){
		printf("------------------------------------------------\n");
		printf("      Inserting Element in  Linked List\n");
		printf("------------------------------------------------\n");
		int occ=0,pos=0;
		struct node* temp=(struct node*)malloc(sizeof(struct node));
		temp->next=NULL;
...
void deleteElement(){
    if(first->next==NULL){
		...
		printf("------------------------------------------------\n");
		printf("  Deleting Element in  Linked List\n");
		printf("------------------------------------------------\n");
		printf("Delete By:- \n1. Roll No.\n2. Name \n3.Index (0 - First, -1 - Last) \nPlease select your mode:- ");
		int type=0;
		fflush(stdin);
...
void swapNodes(){
	if(first->next!=NULL && (first->next)->next!=NULL){
		...
		printf("------------------------------------------------\n");
		printf("         Swapping Linked List Nodes\n");
		printf("------------------------------------------------\n");
		int pos=0,occ=0;
		printf("Please enter the position of left node to be swapped(0 - First, -1 - Second Last):- ");
		fflush(stdin);
		scanf("%d",&occ);
		if(occ==0){
			...
			pos=0;
			struct node* cur=first->next;
	        while((cur->next)->next->next!=NULL && pos!=occ){
				pos++; 
	            cur=cur->next;
	        }
	        if(pos!=occ){
	        	printf("Linked List does not have enough nodes! \n");
			}else{
				struct node* temp=cur->next;
				cur->next=cur->next->next;
		...
		printf("Swapped Linked List Elements at Occurence %d!\n",occ);
		
	}else{
		printf("Linked List has not been created or it does not have enough nodes! \n");
	}
}
...
void clearScreen(){
	...
	printf("2. Insert Element in Linked List\n");
	printf("3. Delete Element in Linked List\n");
	printf("4. Search Element in Linked List\n");
	printf("5. Display  Linked List\n");
	printf("6. Delete  Linked List\n");
	printf("7. Clear Screen\n");
	printf("8. Swap Consecutive Nodes\n");
	printf("9. Exit\n");
}
