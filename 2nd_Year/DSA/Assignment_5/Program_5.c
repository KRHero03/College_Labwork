...
void createLinkedList(){
	if(first->next==NULL){
		...
		printf("Doubly Circular Linked List has been created! \n");

	}else{
		printf("Doubly Circular Linked List has already been created!\n");
	}
}
...
void insertElement(){
	if(first->next!=NULL){
		printf("------------------------------------------------\n");
		printf("Inserting Element in Doubly Circular Linked List\n");
		printf("------------------------------------------------\n");
		int occ=0,pos=0;
		struct node* temp=(struct node*)malloc(sizeof(struct node));
		temp->next=first;
		...
		printf("Doubly Circular Linked List has not been created!\n");
	}
}
...
void searchElement(){
	if(first->next==NULL){
		printf(" Linked List has not been created!\n");
    }else{

		printf("------------------------------------------------\n");
		printf("Searching Element in Doubly Circular Linked List\n");
		printf("------------------------------------------------\n");
...
void deleteByIndex(){
    ...
    if(occ==0){
        ...
        scanf("%c",&y);
        if(y=='y'||y=='Y'){
        	((first->next)->next)->prev=(first->next)->prev;
        	first->next=(first->next)->next;            	
            printf("Element Deleted! \n");
            return;
        }else{
...
void deleteElement(){
    if(first->next==NULL){
		...
		printf("------------------------------------------------\n");
		printf(" Deleting Element in Doubly Circular Linked List\n");
		printf("------------------------------------------------\n");
		printf("Delete By:- \n1. Roll No.\n2. Name \n3.Index (0 - First, -1 - Last) \nPlease select your mode:- ");
		int type=0;
		fflush(stdin);
...
void deleteLinkedList(){	
	char y;
	printf("------------------------------------------------\n");
	printf("       Deleting Doubly Circular Linked List\n");
	printf("------------------------------------------------\n");
    ...
    if(y=='y'||y=='Y'){
    	first->next=NULL; 	
        printf("Doubly Circular Linked List has been deleted! \n");
        return;
    }else{
...
void clearScreen(){
	system("cls");
	printf("------------------------------------------------\n");
	printf("      Doubly Circular Linked List Program\n");
	printf("------------------------------------------------\n");
	printf("                     Menu\n");
	printf("1. Create Linked List\n");
	printf("2. Insert Element in Doubly Circular Linked List\n");
	printf("3. Delete Element in Doubly Circular Linked List\n");
	printf("4. Search Element in Doubly Circular Linked List\n");
	printf("5. Display Doubly Circular Linked List\n");
	printf("6. Delete Doubly Circular Linked List\n");
